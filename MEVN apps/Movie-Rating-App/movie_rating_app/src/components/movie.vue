...
const wrapper = document.createElement('div'); // shared state 
const state = {
	note: 0,
};
...
How was your experience getting help with this issues? <star-rating v-model="rating" :show-rating="false"></star-rating> </div>`,
	components: {
